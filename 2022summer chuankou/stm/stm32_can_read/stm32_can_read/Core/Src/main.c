...
int main(void)
{
  ...
  MX_CAN2_Init();
  /* USER CODE BEGIN 2 */
  HAL_GPIO_WritePin(GPIOH,GPIO_PIN_12,GPIO_PIN_SET);//HAL_GPIO_WritePin(GPIOH, GPIO_PIN_10,GPIO_PIN_SET);
 ...
 // HAL_CAN_ActivateNotification(&hcan2,);
  ...
  while (1)
  {
    ...
    /* USER CODE END WHILE */
	  if(HAL_CAN_GetRxMessage(&hcan2, CAN_FilterFIFO0,&rx,tx_data)==HAL_OK)
	  {
